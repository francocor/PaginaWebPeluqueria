      ...
      <Container fluid className="promo-container pt-5 mt-5">
        <Row className="align-items-center justify-content-center">
          <Col xs={12} md={6} className="d-flex justify-content-center promo-video" data-aos="zoom-in-right">
            <video
              className="video-responsive w-100 h-auto"
              src={promoDelMes}
              autoPlay
              muted
              loop
          ...
          <Col xs={12} md={6} className="promo-text d-flex flex-column justify-content-center text-center text-md-start" data-aos="zoom-in-left">
            <h1 className="mb-4"><HiFire/> Promos de Agosto <HiFire/></h1>
            <a href="./MainTurnos" className="botonpromo d-block my-2" target="_blank">
              <p><FaHeart/> Lavado+Corte+Brashing/plancha $</p>
            </a>
            <a href="./MainTurnos" className="botonpromo d-block my-2" target="_blank">
